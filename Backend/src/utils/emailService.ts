      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          ...
          <div>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${"http://localhost:3000"}/client" style="background-color: #3b82f6; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold;">Accéder à mon compte</a>
            </div>
            <p>Cordialement,<br>L'équipe TipInvest</p>
          </div>
        </div>
