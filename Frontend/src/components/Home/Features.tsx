...
export default () => {
    ...
    const features = [
        ...
        },
        {
            ...
            desc: "Explorez vos investissements en immersion grâce à des rendus 3D ultra-réalistes."
        },
        {
            icon:
            ...
            desc: "Prenez des décisions stratégiques avec des simulations et analyses détaillées."
        }
    ]
