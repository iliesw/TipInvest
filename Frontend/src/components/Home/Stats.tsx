const Stats = () => {
  return (
    <div className="w-full flex justify-center px-4">
      <div className="bg-white block w-full max-w-[80rem] my-[150px] rounded-[20px] outline outline-2 outline-dashed outline-[rgba(0,0,0,0.153)] p-[55px] box-border">
        <div className="flex flex-col lg:flex-row gap-[40px] lg:gap-[80px] pt-[15px] items-center">
          ...
          <p className="w-full lg:w-[120%] h-full text-start opacity-50 font-versel">
