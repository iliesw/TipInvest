...
export default function Example() {
  ...
  return (
    <div className=" relative z-50">
      <header className="absolute inset-x-0 top-0 z-50 justify-center flex">
        <nav aria-label="Global" className="flex items-center justify-between p-6 w-2/3 lg:px-8">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-1xl py-32">
          ...
          <div className="text-center">
            ...
            Investissez dans l’immobilier de demain, dès aujourd’hui!
            </h1>
            <p className="mt-8 text-md font-medium text-pretty text-gray-500">
            Avec TipInvest, anticipez l’avenir et investissez dès aujourd’hui dans l’immobilier de demain grâce à une plateforme innovante et accessible
            </p>
